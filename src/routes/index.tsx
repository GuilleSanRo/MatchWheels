    ...
    <main className="min-h-screen px-4 sm:px-6 py-10 sm:py-14">
      <div className="mx-auto w-full max-w-[1040px]">
        ...
        <header className="mb-10 sm:mb-12">
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-white/70 backdrop-blur px-3 py-1 text-xs text-muted-foreground mb-5 shadow-soft">
            <Sparkles className="h-3.5 w-3.5 text-[oklch(0.59_0.22_280)]" />
            Deterministic. Local. Premium.
          </div>
          <MatchWheelsTitle />
        ...
        <footer className="mt-16 text-center text-xs text-muted-foreground">
          Built for deterministic, auditable Excel matching. ©{" "}
          {new Date().getFullYear()} MatchWheels.
        </footer>
      </div>
    </main>
  );
